...
export function SycCardAmbiental() {
  return (
    <div className="w-full max-w-[300px] rounded-2xl border border-[#E5E9EE] bg-white px-[22px] pt-[26px] pb-5 shadow-[0_8px_24px_rgba(11,79,108,0.06)]">
      ...
      <div className="flex items-center justify-between gap-3 py-[7px] text-[13px]">
        <span className="flex min-w-0 flex-1 items-center gap-2 text-[#6B7280]">
          <HugeiconsIcon
            icon={TaskDone01Icon}
            size={15}
            className="shrink-0 text-[#0B4F6C]"
          />
          <span className="min-w-0">Aplicación del sistema de gestión</span>
        </span>
        <span className="shrink-0 font-semibold text-[#08344A]">71%</span>
      </div>
      <div className="flex items-center justify-between gap-3 border-t border-[#EEF1F5] py-[7px] text-[13px]">
        ...
        <span className="shrink-0 font-semibold text-[#08344A]">68%</span>
      </div>
