...
export function NormasTable() {
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-[#E1E5F5] bg-white shadow-[0_8px_24px_rgba(17,28,78,0.06)]">
      <div className="border-b border-[#E1E5F5] px-6 py-4">
      ...
      <div className="overflow-x-auto">
        <table className="w-full border-collapse text-[13px]">
          <thead>
            <tr className="border-b border-[#E1E5F5] text-left text-[11.5px] tracking-wide text-[#9CA5B0] uppercase">
              ...
              return (
                ...
                >
                  ...
                  <td className="px-3 py-3">
                    <div className="font-semibold text-[#111C4E]">
                      {norma.norma}
                    </div>
