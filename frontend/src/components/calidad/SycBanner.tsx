...
export function SycBanner() {
  return (
    <div className="flex flex-col items-center gap-6 rounded-2xl border border-[#E1E5F5] bg-white px-7 py-6 shadow-[0_8px_24px_rgba(17,28,78,0.06)] sm:flex-row sm:items-center">
      ...
      <div className="h-px w-full bg-[#EEF1F5] sm:h-10 sm:w-px" />

      <div className="flex-1 text-center sm:text-left">
        <div className="font-heading text-base font-bold text-[#111C4E]">
      ...
      <span className="flex shrink-0 items-center gap-1.5 text-sm font-bold text-[#2436A6]">
        Ingresar al sistema
